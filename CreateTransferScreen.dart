...
class _CreateTransferScreenState extends State<CreateTransferScreen> implements ResponseListener {

  String TAG = "_CreateTransferScreenState";
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Center(
                        child: Text(
                          Constant.LANG == Constant.EN ? ENG.PAYMENT_REGISTRY_T_HEADING_MAIN : IT.PAYMENT_REGISTRY_T_HEADING_MAIN,
      ...
      onTap: () async {
        ...
        setState(() {
          if(filterWalletResult != null) {
            ...
            selectedWalletId = filterWalletResult["name"];
  ...
  void onSuccess(response, responseCode) {
    if (responseCode == GET_PAYMENT_MODE) {
      ...
      setState(() {
        ...
        selectedWalletValue2 = walletList[0]["name"].toString();
        selectedWalletId2 = walletList[0]["id"];

        selectedModeValue = paymentModeList[0]["name"].toString();
        selectedModeId = paymentModeList[0]["id"];
        filterModeResult = paymentModeList[0];
  ...
  void savePaymentTransaction() {
    ...
    request.getResponse(
        cmd: RequestCmd.savePaymentTransfer,
        token: userModel!.authorization,
        body: body,
