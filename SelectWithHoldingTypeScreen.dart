...
class SelectWithHoldingTypeScreen extends StatefulWidget {

  var selectedWithHoldingType;

  SelectWithHoldingTypeScreen({Key? key, this.selectedWithHoldingType}) : super(key: key);

  @override
  State<SelectWithHoldingTypeScreen> createState() => _SelectWithHoldingTypeScreenState();
}

class _SelectWithHoldingTypeScreenState extends State<SelectWithHoldingTypeScreen> implements ResponseListener {

  String TAG = "_SelectWithHoldingTypeScreenState";
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          Constant.LANG == Constant.EN ? ENG.SELECT_WITH_HOLDING_TYPE_TITLE : IT.SELECT_WITH_HOLDING_TYPE_TITLE,
      ...
      body: ModalProgressHUD(
        ...
        child: Column(
          ...
          children: [
            Expanded(
                child: withHoldingTypeList.isEmpty
                    ? Container(
                  child: Center(
                    child: Column(
                      mainAxisAlignment: MainAxisAlignment.center,
                  ...
                  child: ListView.separated(
                    itemCount: withHoldingTypeList.length,
                    ...
                    itemBuilder: (BuildContext context, int index) {
                      return InkWell(
                        onTap: () {
                          Navigator.pop(context, withHoldingTypeList[index]);
                        },
                        child: ListTile(
                          title: Text(
                            withHoldingTypeList[index]["name"],
                            style: gothamRegular.copyWith(
