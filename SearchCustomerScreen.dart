...
class _SearchCustomerScreenState extends State<SearchCustomerScreen> implements ResponseListener {

  String TAG = "_SearchCustomerScreenState";
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          Constant.LANG == Constant.EN ? ENG.SEARCH_CUSTOMER_TITLE : IT.SEARCH_CUSTOMER_TITLE,
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    return Container(
                      ...
                      child: InkWell(
                        onTap: () async {
                          Navigator.pop(context, {"customer": customerList[index]});
                        },
                        child: Column(
  ...
  void getCustomerList(bool show) {
    ...
    GetRequest request = GetRequest();
    request.getResponse(
        cmd: "${RequestCmd.getCustomerList}?page=$page&per_page=$limit&customer_type=3&term=$searchText&tags=&gtags=&comTags=",
        token: userModel!.authorization,
  ...
  void onSuccess(response, responseCode) {
    if(responseCode == GET_SUBSCRIPTION) {
